...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../server/server */ "./src/server/server.js");
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_server_server__WEBPACK_IMPORTED_MODULE_8__.postData)("http://localhost:3000/request", json).then(function () {
        (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showThanksModal)(msg.success, ".modal", modalTimerId);
        statusMessage.remove();
      })["catch"](function () {
        (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showThanksModal)(msg.failure, ".modal", modalTimerId);
      })["finally"](function () {
        form.reset();
      });
...
/* harmony import */ var _menuCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./menuCard */ "./src/modules/menuCard.js");
  ...
  axios.get("http://localhost:3000/menu").then(function (data) {
    data.data.forEach(function (_ref) {
      var img = _ref.img,
        ...
        descr = _ref.descr,
        price = _ref.price;
      new _menuCard__WEBPACK_IMPORTED_MODULE_4__.MenuCard(img, altimg, title, descr, price, ".menu .container").render();
    });
  });
...
function slider(_ref) {
  ...
  if (slides.length < 10) {
    ...
    current.textContent = "0".concat(slideIdx);
  } else {
  ...
  next.addEventListener("click", function () {
    ...
    slidesFied.style.transform = "translateX(-".concat(offset, "px)");
...
function tabs(tabsParentSelector, tabsSelector, tabsContentSelect, activeClass) {
...
/* harmony import */ var _modules_menuCard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/menuCard */ "./src/modules/menuCard.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_loader__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".tabheader__items", ".tabheader__item", ".tabcontent", "tabheader__item_active");
  ...
  _modules_menuCard__WEBPACK_IMPORTED_MODULE_5__.MenuCard;
